...
/*   Updated: 2023/08/29 19:34:55 by abenlahb         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ray_cast(t_my_map *src)
{
    ...
    while(i < CASTED_RAYS)
    {
        ...
        while(j < src->rayD)
        {
            ...
            line(src,src->player_x,src->player_y,tar_x,tar_y);
            j++;
        }
        i++;
    }
...
void minimap(t_my_map *src)
{
    ...
    draw_circle(src,src->player_x,src->player_y,5);
